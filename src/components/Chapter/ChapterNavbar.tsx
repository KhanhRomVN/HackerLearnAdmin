// src/components/Chapter/ChapterNavbar.tsx
...
import { AddChapterTooltip } from "@/components/Chapter/AddChapterTooltip"; 
...
interface ChapterNavbarProps {
  ...
  courseId: string; // Thêm courseId để biết chapter thuộc course nào
}

export function ChapterNavbar({ columns, onToggleColumn, onSearch, courseId }: ChapterNavbarProps) {
  return (
    <div className="border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="flex h-16 items-center px-4 gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          {/* Add Chapter Button */}
          <AddChapterTooltip courseId={courseId} />
        </div>
      </div>
    </div>
  );
